...
async function fixConstraints() {
  ...
  const sqlStatements = [
    ...
    `ALTER TABLE menu_items ADD CONSTRAINT menu_items_category_check CHECK (category IN ('espresso', 'latte', 'cappuccino', 'mocha', 'americano', 'flat_white', 'macchiato', 'frappuccino', 'cold_brew', 'soda', 'light_bites', 'pasta', 'sandwich'))`,
  ];
